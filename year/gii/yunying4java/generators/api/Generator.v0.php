...
namespace year\gii\yunying4java\generators\api;

use schmunk42\giiant\helpers\GiiantFaker;
use year\gii\yunying4java\Config;
use year\gii\yunying4java\utils\QualifiedTypeValidator;
use Yii;
...
//            'modelClass' => 'Model Class',
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            'podPath' => 'This is the pod home dir for your specified pod . e.g., <code>\$GOPATH\src\github.com\yunying4java\yunying4java\pods\user</code>',
...
//            'baseControllerClass', 'indexWidgetType'
    ...
    public function genFakeRecord($table)
    {
        ...
        foreach ($table->columns as $column) {
            $columnPhpType = $column->phpType;
            $fakeRow[$column->name] =   \year\gii\yunying4java\helpers\GiiantFaker::value(
                $columnPhpType,
                $column->name
            )  ;//  call_user_func_array(['year\gii\yunying4java\helpers\GiiantFaker',$columnPhpType],[$column->name] );
