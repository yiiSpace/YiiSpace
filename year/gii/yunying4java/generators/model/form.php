...
/* @var $generator \year\gii\yunying4java\generators\model\Generator */
...
echo \year\gii\yunying4java\widgets\PathSelector::widget([
    'onSelection'=>$onSelection,
]);

echo $form->field($generator, 'srcDir');

echo $form->field($generator, 'generateModelDir')->checkbox();
