...
namespace year\gii\yunying4java\generators\crud;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function generate()
    {
        $interactorFile =  implode(DIRECTORY_SEPARATOR,[
            $this->podPath,
            'usecase',
            Inflector::camel2id($this->interactorName.'Interactor','_').'.go'
        ]);

        $files = [
            new CodeFile($interactorFile, $this->render('interactor.go.php')),
        ];
