...
<?php endforeach; ?>
    ...
    *
    * @param $olyunyinglue previously used value
    * @param $attributeName model's attribute name
    * @param $attributeType model's attribute type
    * @return mixed
    */
    private function updateAttributeValue($olyunyinglue, $attributeName, $attributeType){
        $newValue = $olyunyinglue;
        while($newValue === $olyunyinglue){
