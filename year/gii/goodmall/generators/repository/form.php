...
echo $form->field($generator, 'repositoryInterfacePath');
echo $form->field($generator, 'repositoryImplementPath');

echo $form->field($generator, 'repositoryInterfaceType');
// echo $form->field($generator, 'repositoryImplementType');
