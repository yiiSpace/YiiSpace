...
$data = array(
  array(
    ...
    'uploadpreview' => "../sample-images/image_1.jpg"
  ),
  array(
    'id' => "2",
    'title' => "Second image",
    ...
    'uploadpreview' => "../sample-images/image_2.jpg"
  ),
  array(
    'id' => "3",
    'title' => "Third image",
    ...
    'uploadpreview' => "../sample-images/image_3.jpg"
  ),
  array(
    'id' => "4",
    'title' => "Fourth image",
    ...
    'uploadpreview' => "../sample-images/image_4.jpg"
  ),
  array(
    'id' => "5",
    'title' => "Fifth image",
    ...
    'uploadpreview' => "../sample-images/image_5.jpg"
  ),
  array(
    'id' => "6",
    'title' => "Sixth image",
    ...
    'uploadpreview' => "../sample-images/image_6.jpg"
  ),
  array(
    'id' => "7",
    'title' => "Seventh image",
    ...
    'uploadpreview' => "../sample-images/image_7.jpg"
  ),
  array(
    'id' => "8",
    'title' => "Eight image",
    ...
    'uploadpreview' => "../sample-images/image_8.jpg"
  ),
  array(
    'id' => "9",
    'title' => "Ninth image",
    ...
    'uploadpreview' => "../sample-images/image_9.jpg"
  ),
  array(
    'id' => "10",
    'title' => "Tenth image",
    ...
    'uploadpreview' => "../sample-images/image_10.jpg"
  )
);
