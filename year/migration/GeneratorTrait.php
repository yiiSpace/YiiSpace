...
// copy from https://github.com/bizley/yii2-migration/blob/master/src/controllers/BaseMigrationController.php

/**
 * NOTE： $view is required for hosting class
 */
