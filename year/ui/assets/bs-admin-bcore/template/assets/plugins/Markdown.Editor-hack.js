...
(function () {
    ...
    // - refreshPreview() forces the uploadpreview to be updated. This method is only available after run() was called.
    Markdown.Editor = function (markdownConverter, idPostfix, help) {

        idPostfix = idPostfix || "";

        var hooks = this.hooks = new Markdown.HookCollection();
        hooks.addNoop("onPreviewRefresh");       // called with no arguments after the uploadpreview has been refreshed
    ...
    function PanelCollection(postfix) {
        ...
        this.preview = doc.getElementById("wmd-uploadpreview" + postfix);
    ...
    function PreviewManager(converter, panels, previewRefreshCallback) {
        ...
        var makePreviewHtml = function () {
            ...
            // If there is no registered uploadpreview panel
