...
<!--    <link href="--><?//= $baseUrl ?><!--/css/ionicons.min.css" rel="stylesheet" type="text/css" />-->
    ...
    <!-- Date Picker -->
    <link href="<?= $baseUrl ?>/css/datepicker/datepicker3.css" rel="stylesheet" type="text/css" />
    <!-- Daterange picker -->
...
<!-- datepicker -->
<script src="<?= $baseUrl ?>/js/plugins/datepicker/bootstrap-datepicker.js" type="text/javascript"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<script src="<?= $baseUrl ?>/js/AdminLTE/demo.js" type="text/javascript"></script>
