...
use year\ui\BCoreAdminAsset;

/**
 * @var \yii\web\View $this
 * @var string $content
 */
$asset = BCoreAdminAsset::register($this);
...
<head>
    ...
    <link rel="stylesheet" href="<?= $baseUrl ?>/assets/css/MoneAdmin.css" />
    <link rel="stylesheet" href="<?= $baseUrl ?>/assets/plugins/Font-Awesome/css/font-awesome.css" />
    <!--END GLOBAL STYLES -->

    <!-- PAGE LEVEL STYLES -->
    <link href="<?= $baseUrl ?>/assets/css/layout2.css" rel="stylesheet" />
    <link href="<?= $baseUrl ?>/assets/plugins/flot/examples/examples.css" rel="stylesheet" />
    <link rel="stylesheet" href="<?= $baseUrl ?>/assets/plugins/timeline/timeline.css" />
...
<div class="media user-media well-small">
    <a class="user-link" href="#">
        <img class="media-object img-thumbnail user-img" alt="User Picture" src="<?= $baseUrl ?>/assets/img/user.gif" />
    </a>
    <br />
                ...
                <ul class="chat">
                    <li class="left clearfix">
                                        <span class="chat-img pull-left">
                                            <img src="<?= $baseUrl ?>/assets/img/1.png" alt="User Avatar" class="img-circle" />
                                        </span>
                    ...
                    <li class="right clearfix">
                                        <span class="chat-img pull-right">
                                            <img src="<?= $baseUrl ?>/assets/img/2.png" alt="User Avatar" class="img-circle" />
                                        </span>
                        <div class="chat-body clearfix">
                            <div class="header">
                    ...
                    <li class="left clearfix">
                                        <span class="chat-img pull-left">
                                            <img src="<?= $baseUrl ?>/assets/img/3.png" alt="User Avatar" class="img-circle" />
                                        </span>
                        <div class="chat-body clearfix">
                            <div class="header">
                                <strong class="primary-font"> Jack Sparrow </strong>
                    ...
                    <li class="right clearfix">
                                        <span class="chat-img pull-right">
                                            <img src="<?= $baseUrl ?>/assets/img/4.png" alt="User Avatar" class="img-circle" />
                                        </span>
                        <div class="chat-body clearfix">
                            <div class="header">
                                <small class=" text-muted">
...
<!-- GLOBAL SCRIPTS -->
<script src="<?= $baseUrl ?>/assets/plugins/jquery-2.0.3.min.js"></script>
<script src="<?= $baseUrl ?>/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
<script src="<?= $baseUrl ?>/assets/plugins/modernizr-2.6.2-respond-1.1.0.min.js"></script>
<!-- END GLOBAL SCRIPTS -->

<!-- PAGE LEVEL SCRIPTS -->
<script src="<?= $baseUrl ?>/assets/plugins/flot/jquery.flot.js"></script>
<script src="<?= $baseUrl ?>/assets/plugins/flot/jquery.flot.resize.js"></script>
<script src="<?= $baseUrl ?>/assets/plugins/flot/jquery.flot.time.js"></script>
<script  src="<?= $baseUrl ?>/assets/plugins/flot/jquery.flot.stack.js"></script>
<script src="<?= $baseUrl ?>/assets/js/for_index.js"></script>
