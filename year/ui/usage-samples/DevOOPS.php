...
use year\ui\DevOOPSAsset;

/**
 * @var \yii\web\View $this
 * @var string $content
 */
$asset = DevOOPSAsset::register($this);
...
<head>
    ...
    <link href="<?= $baseUrl ?>/plugins/jquery-ui/jquery-ui.min.css" rel="stylesheet">
    ...
    <link href="<?= $baseUrl ?>/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
    <link href="<?= $baseUrl ?>/plugins/xcharts/xcharts.min.css" rel="stylesheet">
    <link href="<?= $baseUrl ?>/plugins/select2/select2.css" rel="stylesheet">
...
<script src="<?= $baseUrl ?>/plugins/justified-gallery/jquery.justifiedgallery.min.js"></script>
<script src="<?= $baseUrl ?>/plugins/tinymce/tinymce.min.js"></script>
<script src="<?= $baseUrl ?>/plugins/tinymce/jquery.tinymce.min.js"></script>
<!-- All functions for this theme + document.ready processing -->
<script src="<?= $baseUrl ?>/js/devoops.js"></script>
<?php $this->endBody() ?>
</body>
</html>
<?php $this->endPage() ?>
