...
<div id="p" class="easyui-panel" title="search"
    ...
    <div class="migration-search" style="padding:10px 60px 20px 60px">
        ...
        <table cellpadding="5">
            <tbody>
                ...
                <?= $form->field($model, 'version',['inputOptions'=>[ 'class' => 'form-control easyui-textbox ']]) ?>

    <?= $form->field($model, 'apply_time',['inputOptions'=>[ 'class' => 'form-control easyui-textbox ']]) ?>
