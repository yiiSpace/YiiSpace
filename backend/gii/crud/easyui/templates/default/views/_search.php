...
<div id="searchPanel<?= ucfirst($modelId) ?>" class="easyui-panel" title="search"
     style="width:100%;height:auto;padding:10px;background:#fafafa;"
     data-options="iconCls:'icon-search',closable:false,
    collapsible:true,maximizable:true">

    <div class="<?= $modelId ?>-search" style="padding:10px 60px 20px 60px">

        <?= "<?php " ?>$form = ActiveForm::begin([
        'action' => ['index'],
        'method' => 'get',
        'options'=>[
             'id'=>'yiiAF_Search<?= ucfirst( $modelId ) ?>',
