...
$shotModelClass = StringHelper::basename($generator->modelClass) ;
...
<?= '<?php ' ?> \year\widgets\JsBlock::begin() ?>
    <script>
         ...
         * */
       function <?= $shotModelClass ?>Admin(){

                this.dataGridSelector = '#dg_<?= $modelId ?>'; // 数据表格的jquery选择器
                // 重新加载数据表格
                ...
                // 高级搜索
                this.advSearchContainerSelector = '#adv_search_container_<?= $modelId ?>';
        ...
        var <?= $modelId ?>Admin = new <?= $shotModelClass ?>Admin();
        // 对象初始化：
